!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?module.exports=e():"function"==typeof define&&define.amd?define(e):t.quicklink=e()}(this,(function(){var t={};function e(t){return new Promise((function(e,i){var r=new XMLHttpRequest;r.open("GET",t,r.withCredentials=!0),r.onload=function(){200===r.status?e():i()},r.send()}))}var i,r=("prefetch",(i=document.createElement("link")).relList&&i.relList.supports&&i.relList.supports("prefetch")?function(t){return new Promise((function(e,i){var r=document.createElement("link");r.rel="prefetch",r.href=t,r.onload=e,r.onerror=i,document.head.appendChild(r)}))}:e);function n(i,n,s){if(!(t[i]||(s=navigator.connection)&&((s.effectiveType||"").includes("2g")||s.saveData)))return(n?function(t){return null==self.fetch?e(t):fetch(t,{credentials:"include"})}:r)(i).then((function(){t[i]=!0}))}var s=window.requestIdleCallback||function(t){var e=Date.now();return setTimeout((function(){t({didTimeout:!1,timeRemaining:function(){return Math.max(0,50-(Date.now()-e))}})}),1)},a=new Set,o=window.IntersectionObserver&&new IntersectionObserver((function(t){t.forEach((function(t){if(t.isIntersecting){var e=t.target;a.has(e.href)&&(o.unobserve(e),l(e.href))}}))}));function l(t){a.delete(t),n(new URL(t,location.href).toString(),o.priority)}return function(t){t||(t={}),o&&(o.priority=t.priority||!1);var e=t.origins||[location.hostname],i=t.ignores||[];(t.timeoutFn||s)((function(){t.urls?t.urls.forEach(l):o&&Array.from((t.el||document).querySelectorAll("a"),(function(t){o.observe(t),e.length&&!e.includes(t.hostname)||function t(e,i){return Array.isArray(i)?i.some((function(i){return t(e,i)})):(i.test||i).call(i,e.href,e)}(t,i)||a.add(t.href)}))}),{timeout:t.timeout||2e3})}}));
/*!
 * VERSION: 2.1.3
 * DATE: 2019-05-17
